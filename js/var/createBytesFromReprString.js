this.createBytesFromReprString = (function script() {
  "use strict";

  /*! createBytesFromReprString.js Version 1.0.0
  ...
  function createBytesFromReprString(string) {
    var i = 0, j = 0, k = 0, codepoint = 0, byte = 0,
        bytes = createBytesFromString(string);
  ...
  createBytesFromReprString.toScript = function () { return "(" + script.toString() + "())"; };
  createBytesFromReprString._requiredGlobals = ["createBytesFromString"];
  return createBytesFromReprString;
