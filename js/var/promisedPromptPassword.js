this.promisedPromptPassword = (function script() {
  "use strict";

  /*! promisedPromptPassword.js Version 1.0.0
  ...
  function promisedPromptPassword(message, value) {
    // /!\ Use with care !
  ...
  promisedPromptPassword.toScript = function () { return "(" + script.toString() + "())"; };
  return promisedPromptPassword;
