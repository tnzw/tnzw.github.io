this.sumBytesToSha256Uint32Array = (function script() {
  "use strict";

  /*! sumBytesToSha256Uint32Array.js Version 1.0.0
  ...
  sumBytesToSha256Uint32Array.toScript = function () { return "(" + script.toString() + "())"; };
  sumBytesToSha256Uint32Array._requiredGlobals = [
    "encodeUint64ToBigEndianBytes",
    "decodeBigEndianBytesToInt32",
    "rotateInt32BitsRight"
  ];

  return sumBytesToSha256Uint32Array;
}());
