this.promisedPromptFilePassword = (function script() {
  "use strict";

  /*! promisedPromptFilePassword.js Version 1.0.0
  ...
  function promisedPromptFilePassword(message, value) {
    // /!\ Use with care !
  ...
  promisedPromptFilePassword.toScript = function () { return "(" + script.toString() + "())"; };
  return promisedPromptFilePassword;
