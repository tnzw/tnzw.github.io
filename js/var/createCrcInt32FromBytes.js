this.createCrcInt32FromBytes = (function script() {
  "use strict";

  /*! createCrcInt32FromBytes.js Version 1.0.0
  ...
  createCrcInt32FromBytes.toScript = function () { return "(" + script.toString() + "())"; };
  return createCrcInt32FromBytes;
