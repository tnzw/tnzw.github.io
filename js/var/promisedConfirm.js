this.promisedConfirm = (function script() {
  "use strict";

  /*! promisedConfirm.js Version 1.0.0
  ...
  function promisedConfirm(message) {
    // /!\ Use with care !
    ...
    var oncancel = null, promise = new Promise(function (resolve) {
      var layout = null, beam = null, windoww = null,
          div = null, p = null, cancel = null, ok = null;
  ...
  promisedConfirm.toScript = function () { return "(" + script.toString() + "())"; };
  return promisedConfirm;
