this.promisedPromptTextarea = (function script() {
  "use strict";

  /*! promisedPromptTextarea.js Version 1.0.0
  ...
  function promisedPromptTextarea(message, value) {
    // /!\ Use with care !
    ...
    var oncancel = null, promise = new Promise(function (resolve) {
      ...
      function onCtrlEnter(e) {
        if (e.ctrlKey && (e.key === "Enter" || e.keyIdentifier === "Enter"))
          onOk();
      }
      function onBlur(e) {
      ...
      input.addEventListener("keydown", onCtrlEnter, {passive: true});
  ...
  promisedPromptTextarea.toScript = function () { return "(" + script.toString() + "())"; };
  return promisedPromptTextarea;
