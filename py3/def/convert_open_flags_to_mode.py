# convert_open_flags_to_mode.py Version 1.0.2
...
def convert_open_flags_to_mode(flags, text=None, use_t=False, os_module=None):
  ...
  fields = "RDONLY, WRONLY, RDWR, APPEND, CREAT, TRUNC, EXCL".split(", ")
  r,w,rw,a,c,t,x = [flags & getattr(os_module, "O_" + _) for _ in fields]
